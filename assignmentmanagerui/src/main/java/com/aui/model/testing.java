...
public class testing {
    ...
    public static void main(String[] args) {
        ...
        /**
         * this was a testing file to test general logic before the login system was implemented with major changes to the data manager
         * It worked but is now outdated due to new implementations
         */
    }
